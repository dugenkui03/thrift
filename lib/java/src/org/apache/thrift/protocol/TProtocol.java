...
public abstract class TProtocol {
  ...
  /**
   * Writing methods：读表示从流中读取到byte缓存区；
   */

  /**
   * 读TMessage、读TStruct、TField、Stop
   */
  ...
  /**
   * 基本类型：boolean、short、byte、int、long、double
   */
  ...
  /**
   * Reading methods：写表示从byte写到流中
   */

  /**
   * TMessage、TStruct、TField
   */
